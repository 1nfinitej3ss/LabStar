class ADbutton
{
  int lightColorButton = #674F2B;
  int darkColorButton = #392B16;
  int innerRectButton = #4B3A20;
  int innerRectButtonLight = #C6C6C6;
  
  int fontColorEnabled=#F8B951;
...
//        text(buttonLabel,buttonX+buttonW/2+1,buttonY+buttonH/2+11+5+1);    
        ...
        text(buttonLabel,buttonX+buttonW/2,buttonY+buttonH/2+11);    
